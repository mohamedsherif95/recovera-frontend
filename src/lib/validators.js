...
export const patientSchema = z.object({
  ...
  phone: optionalStringField(z.string().min(5, 'Phone number must be at least 5 digits').max(20, 'Phone number must be at most 20 digits')),
  ...
  reassessmentCycleLength: optionalNumberField(
    z
      .number({ invalid_type_error: 'Reassessment cycle length must be a number' })
...
export const sessionSchema = z.object({
  ...
  patientId: z.number({ required_error: 'validation.sessions.patientRequired' }),
